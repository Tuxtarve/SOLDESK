...
--
-- 절차 요약
--  1) 적재 전: SELECT show_id, remain_count FROM concert_shows + concerts WHERE title 5만석
...
--   SELECT show_id, show_date, remain_count, total_count
...
-- 잔여석(대량 성공 시 total - active 좌석 수와 일치하는지)
